...
--SORU2: Tüm aktör name leri ve film name leri listeleyiniz
SELECT actor_name,film_name from filmler  RIGHT JOIN aktorler ON filmler.film_id=aktorler.film_id;
